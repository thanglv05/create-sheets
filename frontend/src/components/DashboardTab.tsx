import { SimpleGrid, Paper, Text, Group, ThemeIcon, Card, Title, TextInput, Button, ActionIcon } from '@mantine/core';
    ...
    <>
      <SimpleGrid cols={{ base: 1, sm: 2, lg: 5 }} mb="xl">
        ...
        <Paper withBorder p="md" radius="md">
          ...
          <Text fw={700} fz="xl" mt="md">{stats.pending}</Text>
        </Paper>
        <Paper withBorder p="md" radius="md">
          <Group justify="space-between">
          ...
          <Text fw={700} fz="xl" mt="md">{stats.running}</Text>
        </Paper>
        <Paper withBorder p="md" radius="md">
          <Group justify="space-between">
          ...
          <Text fw={700} fz="xl" mt="md">{stats.done}</Text>
        </Paper>
        <Paper withBorder p="md" radius="md">
          <Group justify="space-between">
          ...
          <Text fw={700} fz="xl" mt="md">{stats.error}</Text>
        </Paper>
      </SimpleGrid>
      ...
      <Card withBorder radius="md" p="xl" mb="xl">
        ...
        <SimpleGrid cols={{ base: 1, sm: 2 }} mb="md">
          <TextInput label="Tên job" placeholder="VD: Tháng 5 – Batch 1" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} />
